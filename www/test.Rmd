...
<p>
Begin by importing your dataset from the Import Data submenu in the sidebar, The
sidebar gives you the option of uploading your own protein abundance and annotation
data, or using a sample dataset from within the <font color = "red">MSstatsSampleSize</font> Package. Click Select Data type and select Example from MStatsSampleSize to start exploring
</p>
...
<img src = ab.PNG width = "550" height = "350">  
...
<img src = an.PNG width = "200" height = "350">
</div>
</div>